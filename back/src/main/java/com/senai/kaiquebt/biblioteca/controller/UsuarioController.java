...
public class UsuarioController {
    ...
    @PostMapping
    public ResponseEntity<Usuario> addUsuario(CriarUsuarioDTO criarUsuarioDTO) {
        return ResponseEntity.ok(this.usuarioService.criarUsuario(criarUsuarioDTO));
    }
    
    @PostMapping("/{id}")
    public ResponseEntity<Usuario> updUsuario(@PathVariable Long id, AtualizarUsuarioDTO atualizarUsuarioDTO) {
